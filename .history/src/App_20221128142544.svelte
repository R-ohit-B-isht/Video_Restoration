...
<div class="grid u-gap-2 u-text-center">
    <div class="grid-c-12 grid-r-1" style="background: linear-gradient(to right, #8e2de2, #4a00e0); color: #fff; border-radius: .25rem;">
        <p><b>	{#if user.loggedin}
		<div in:fade>
    ...
    <div class="grid-c-4 grid-r-19" style="background: linear-gradient(to right, #8e2de2, #4a00e0); color: #fff; border-radius: .25rem;">
        <b><p>Dashboard</p></b>
